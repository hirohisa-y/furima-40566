class Form 
  ...
  attr_accessor :post_code, :prefecture_id, :municipality, :street_address, :building_name, :telephone_number, :user_id, :item_id, :token, :price
  ...
  validates :telephone_number, length: { minimum: 10, maximum: 11 }, format:{ with: /\A\d{10,11}\z/, message: "input only number" } 
